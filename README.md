...
2. DOM and Page-Level Handling (`content.js`): Especially on platforms like YouTube, it automatically catches stubborn in-stream video ads and skip buttons that bypass network filters, handling them smoothly.(not sure yet)
